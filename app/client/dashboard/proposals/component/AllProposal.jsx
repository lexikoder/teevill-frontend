...
import AllProposalListAction from "./AllProposalListAction";
...
export default function AllProposal({ payments, refetch }) {
          ...
          <Tbody mt="100px">
            {paginatedPayments?.map((payment, index) => (
              <Tr key={index}>
                ...
                <Td>
                  <AllProposalListAction data={payment} refetch={refetch}/>
                </Td>
              </Tr>
            ))}
          </Tbody>
